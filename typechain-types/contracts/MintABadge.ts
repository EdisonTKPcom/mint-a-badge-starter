...
export interface MintABadgeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface MintABadge extends BaseContract {
  connect(runner?: ContractRunner | null): MintABadge;
  waitForDeployment(): Promise<this>;

  interface: MintABadgeInterface;
